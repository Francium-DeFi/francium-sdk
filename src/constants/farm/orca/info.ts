...
export const ORCA_FARM_CONFIG = {
  ...
  'SLC-USDC': {
    ...
    programId: lyfOrcaProgramId,
    tknMint0: TOKENS.USDC.mintAddress,
    tknMint1: TOKENS.SLC.mintAddress,
    ...
    lendingPoolConfig: {
      ...
      '1': {
        tknMint: TOKENS.SLC.mintAddress,
    ...
    ammInfo: {
      ...
      doubleDipPool: {
        rewardTknMint: TOKENS.SLC.mintAddress,
  ...
  'MEAN-USDC': {
    ...
    protocolSubVersion: 1,
    alias: null,
    orcaPoolId: 'MEAN/USDC[aquafarm]',

    programId: lyfOrcaProgramId,
    tknMint0: TOKENS.USDC.mintAddress,
    tknMint1: TOKENS.MEAN.mintAddress,
    ...
    lendingPoolConfig: {
      ...
      '1': {
        tknMint: TOKENS.MEAN.mintAddress,
    ...
    ammInfo: {
      ...
      doubleDipPool: {
        rewardTknMint: TOKENS.MEAN.mintAddress,
  ...
  'ORCA-whETH': {
    ...
    protocolSubVersion: 1,
    alias: null,
    orcaPoolId: 'ORCA/whETH[aquafarm]',
  ...
  'GST-USDC': {
    ...
    protocolSubVersion: 1,
    alias: null,
    orcaPoolId: 'GST/USDC[aquafarm]',

    programId: lyfOrcaProgramId,
    tknMint0: TOKENS.USDC.mintAddress,
    tknMint1: TOKENS.GST.mintAddress,
    ...
    lendingPoolConfig: {
      ...
      "1": {
        tknMint: TOKENS.GST.mintAddress,
  ...
  'GMT-USDC': {
    ...
    protocolSubVersion: 1,
    alias: null,
    orcaPoolId: 'GMT/USDC[aquafarm]',

    programId: lyfOrcaProgramId,
    tknMint0: TOKENS.USDC.mintAddress,
    tknMint1: TOKENS.GMT.mintAddress,
    ...
    lendingPoolConfig: {
      ...
      "1": {
        tknMint: TOKENS.GMT.mintAddress,
  ...
  'stSOL-SOL': {
    ...
    needsCompound: true,
    alias: null,
    orcaPoolId: 'stSOL/SOL[stable][aquafarm]',

    protocolVersion: 2,
    protocolSubVersion: 2,

    programId: lyfOrcaProgramId,
    tknMint0: TOKENS.WSOL.mintAddress,
    tknMint1: TOKENS.stSOL.mintAddress,
    ...
    lendingPoolConfig: {
      ...
      "0": {
        tknMint: TOKENS.WSOL.mintAddress, // wsol
        lendingPoolInfoAccount: new PublicKey("EnZC8MB6QLTxwN1LNqCXYC7XMpvXqitnYQPf5y5AcQRn"),
        lendingPoolTknAccount: new PublicKey("GiJwrxQW5NQWWAva4rnDMXwHxfrhyUzwMX5to1pmCCgF"),
        lendingPoolFeeAccount: new PublicKey("wLq5xWzkgfH1T2bbByBoUFxKk5g4K2urQv8q71gCsbM"),
        lendingPoolShareMint: new PublicKey("92Zst3rEoJsyZUW2yNc2811GtkBwFrm3tqgxMTtFWuSB"),
